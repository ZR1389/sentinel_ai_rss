...
plans = [
    ...
    # telegram, insights, alerts, darkweb_monitoring, human_security_support, early_access_new_features, newsletter
    ("FREE", 0, 0, 5, 3, False, False, True, False, False, False, True),
    ("PRO", 4999, 20, 1000, 500, True, True, True, True, False, True, True),
    ("ENTERPRISE", 19999, None, 10000, 5000, True, True, True, True, True, True, True),
]
